...
if __name__ == '__main__':
    ...
    input_shape = (250, 12)  
    output_dims = 6   
    EP = 50 #modifica 4: EP 100 -> 10, 10 -> 20
    LR = 1e-3/2 #modifica 2: LR 1e-3 -> 1e-4
    BS = 1024 #modifica 3: BS 512 -> 32
    ...
    try:
        x_train_raw, y_train_raw = load_h5_data("train_dataset_clean.h5")
        x_val_raw, y_val_raw = load_h5_data("val_dataset_clean.h5")
        x_test_raw, y_test_raw = load_h5_data("test_dataset_clean.h5")
    ...
    pic_path_ptb = os.path.join(base_dir, "confusion_matrix_test.png")
    pic_path_ptbxl = os.path.join(base_dir, "confusion_matrix_val.png")
    ...
    history_array = np.load(save_path + '_history.npy', allow_pickle=True)
    print_history(history_array)
    plt.show()