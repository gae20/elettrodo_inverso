...
def build_model(input_shape=(250, 6), output_dims=10):
    """
    input_shape: (length, channels), per 2s a 125 Hz => (250, n_canali)
    ...
    return Model(inputs, outputs, name="ILC_250samples")


if __name__ == "__main__":
    input_shape = (250, 6)   # 2 s * 125 Hz = 250 samples
    output_dims = 10
