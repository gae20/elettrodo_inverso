...
from utils.config import SAMPLES_PER_WINDOW, ACTIVE_SYNTH_CLASSES

# --- Percorsi ---
DATASETS_DIR  = os.path.abspath(os.path.join(THESIS_DIR, '..', 'datasets'))

DATASET_TRAIN = os.path.join(DATASETS_DIR, 'unlabelled_final_noise_limbs_train_ssl.h5')
DATASET_VAL   = os.path.join(DATASETS_DIR, 'unlabelled_final_noise_limbs_val.h5')
DATASET_TEST  = os.path.join(DATASETS_DIR, 'labelled_z_median_limbs_test_validation.h5')
