...
if __name__ == '__main__':
    ...
    # Path dataset
    train_h5_path = 'train_dataset_new_precordial.h5'
    val_h5_path   = 'val_dataset_new_precordial.h5'
    test_h5_path  = 'test_dataset_new_precordial.h5'
    ...
    # Determina automaticamente il numero di classi
    num_classes = int(max(
        y_train_raw.max(),
        y_val_raw.max(),
        y_test_raw.max()
    ...
    print(f"Numero classi rilevato: {output_dims}")

    # One-hot encoding etichette
    ...
    pic_path_test = 'confusion_matrix_precordial.png'
    metrics_result_test, test_acc = evaluater(
        x_test,
        y_test_raw,
        best_model,
        pic_path_test
    ...
    print("Metriche per classe (precision, recall, specificity, f1):")
